...
var _GDPData = __webpack_require__(0);

var _GDPData2 = _interopRequireDefault(_GDPData);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var data = _GDPData2.default.data;

// notes
d3.select(".notes").text(_GDPData2.default.description);
...
rootGroup.selectAll("rect").data(data).enter().append("rect").attr("x", function (d) {
    return x(d.date);
}).attr("y", function (d) {
    return y(d.GDP);
}).attr("width", x.bandwidth()).attr("height", function (d) {
    return height - y(d.GDP);
}).attr("fill", "url(#chart-background)").on("mouseover", function (d) {
    ...
    tooltip.style("left", d3.event.pageX + 5 + "px").style("top", d3.event.pageY - 50 + "px").style('display', 'block');
